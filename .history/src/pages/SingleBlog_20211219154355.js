...
function SingleBlog() {
    ...
    useEffect( ()=>{
        const fethApi = async ()=>{
            ...
            document.querySelector('.blog-details__details').innerHTML(response.data.data.detail) 
                ...
                <div className="row">
                    <div className="col-lg-8">
                        ...
                        <div className="blog-details__content">
                            ...
                            <div className="blog-details__bottom"><div className="sidebar__social-list"><span className="px-2">Chia sẻ</span><a href="https://www.facebook.com/sharer/sharer.php?u=https%3a%2f%2fphutho.vietnaminfo.net%2fvi%2fblog%2fdetails%2fgioi-thieu-chung-ve-tinh-phu-tho-1&amp;title=Gi%e1%bb%9bi+thi%e1%bb%87u+chung+v%e1%bb%81+t%e1%bb%89nh+Ph%c3%ba+Th%e1%bb%8d" target="_blank"><i className="fab fa-facebook-f"></i></a><a href="https://twitter.com/intent/tweet?url=https%3a%2f%2fphutho.vietnaminfo.net%2fvi%2fblog%2fdetails%2fgioi-thieu-chung-ve-tinh-phu-tho-1&amp;text=Gi%e1%bb%9bi+thi%e1%bb%87u+chung+v%e1%bb%81+t%e1%bb%89nh+Ph%c3%ba+Th%e1%bb%8d" target="_blank"><i className="fab fa-twitter"></i></a><a href="https://telegram.me/share?url=Gi%e1%bb%9bi+thi%e1%bb%87u+chung+v%e1%bb%81+t%e1%bb%89nh+Ph%c3%ba+Th%e1%bb%8d&amp;text=https%3a%2f%2fphutho.vietnaminfo.net%2fvi%2fblog%2fdetails%2fgioi-thieu-chung-ve-tinh-phu-tho-1" target="_blank"><i className="fab fa-telegram-plane"></i></a><a href="https://pinterest.com/pin/create/button/?url=https%3a%2f%2fphutho.vietnaminfo.net%2fvi%2fblog%2fdetails%2fgioi-thieu-chung-ve-tinh-phu-tho-1&amp;media=%2fDataFiles%2f2021%2f06%2fFiles%2f20210605-102218-KYUOhFG9.jpg&amp;description=Gi%e1%bb%9bi+thi%e1%bb%87u+chung+v%e1%bb%81+t%e1%bb%89nh+Ph%c3%ba+Th%e1%bb%8d" target="_blank"><i className="fab fa-pinterest-p"></i></a><a href="https://www.linkedin.com/shareArticle?mini=true&amp;url=https%3a%2f%2fphutho.vietnaminfo.net%2fvi%2fblog%2fdetails%2fgioi-thieu-chung-ve-tinh-phu-tho-1" target="_blank"><i className="fab fa-linkedin-in"></i></a></div></div>
                            ...
                            <ul className="sidebar__post-list list-unstyled">
                                <li>
                                    ...
                                    <div className="sidebar__post-content">
                                        <h3><a href="#">Dự án nghỉ dưỡng tại Phú Thọ - Nổi bật nhờ những dịch vụ độc đáo</a></h3>
                                    </div>
                                </li>
                                <li>
                                    <div className="sidebar__post-image">
