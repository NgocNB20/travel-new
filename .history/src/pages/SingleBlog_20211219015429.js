                            ...
                            <ul className="sidebar__post-list list-unstyled">
                                <li>
                                    <div className="sidebar__post-image">
                                        <div style={{width: '61px', height: '63px', backgroundImage: 'url(/DataFiles/2021/06/Files/20210605-230421-9K532hgf_thumb.jpeg)'}} className="bg-img" />
                                    </div>
                                ...
                                <li>
                                    <div className="sidebar__post-image">
                                        <div style={{width: '61px', height: '63px', backgroundImage: 'url(/DataFiles/2021/06/Files/20210605-225725-A8Ecm9ZA_thumb.jpg)'}} className="bg-img" />
                                    </div>
                                    <div className="sidebar__post-content">
