...
function SingleTour() {
    ...
    const{title,numberView,numberLike,rate,detail
        ,price,totalDay,totalPerson,detailSummary,departure,imageTours,subDetail}={...tour};
    ...
    if(detail){
        ...
        document.querySelector('.subDetail').innerHTML=subDetail;
    } 
    ...
    return (
        <>
            ...
            <section className="tour-two tour-list">
                ...
                <div className="blog-details__details subDetail"></div>
                <Share/>
