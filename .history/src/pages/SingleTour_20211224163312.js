...
function SingleTour() {
    ...
    return (
        ...
        <div id="reviewItem1" data-rating-input="#reviewStar1" data-rating-color="#fcd703" data-rating-half="true" data-rating-stars={5} data-rating-value={0} rating="true" style={{color: 'rgb(252, 215, 3)'}}>
          <i className="fas fa-star" style={{cursor: 'pointer', width: '22px'}} />
          <i className="fas fa-star-half-alt" style={{cursor: 'pointer', width: '22px'}} /><i className="far fa-star" style={{cursor: 'pointer', width: '22px'}} />
          <i className="far fa-star" style={{cursor: 'pointer', width: '22px'}} />
          <i className="far fa-star" style={{cursor: 'pointer', width: '22px'}} />
        </div>
        <input type="hidden" id="reviewStar1" defaultValue="1.5" data-id={1} />
        <p />
      </div>
                        </div>
                    <FormComent/>
