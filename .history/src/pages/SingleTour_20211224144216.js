    ...
    return (
        <>
            ...
            <div className="tour-details__content">
                ...
                <ul className="tour-one__meta list-unstyled"><li><a><i className="far fa-clock" /> 5 Ngày 4 Đêm </a></li><li><a><i className="far fa-user-circle" /> 15</a></li><li><a><i className="far fa-bookmark" /> </a></li><li><a><i className="fas fa-bus-alt" /> Thành phố Hồ Chí Minh</a></li></ul>
            </div>
        </>
    )
}
