...
import {URL_LOGO} from "../constants/constant.js";
          ...
          <div className="container">
            <div className="main-nav__logo-box">
              <Link to="/vi" className="main-nav__logo">
                <img src={URL_LOGO} className="main-logo" width="123px" alt="Cổng thông tin du lịch Phú Thọ" /></Link>
              <Link to="/" className="side-menu__toggler"><i className="fa fa-bars" /></Link>
            </div>
            <div className="main-nav__main-navigation">
              <ul className="main-nav__navigation-box">
                <li><Link  to="/vi"  >TRANG CHỦ</Link></li>
                <li><Link to="/vi/blogs/detail/1">GIỚI THIỆU</Link></li>
