...
function Blog({blog}) {
    ...
    return (
        <div className="blog-one__single ">
            ...
            <div style={{width: '100%', height: '300px', backgroundImage: 'url(../assets/image/anh2.jpg)'}} className="bg-img"DataFiles/2021/06/Files/20210605-230421-9K532hgf.jpeg)'}} className="bg-img" />
