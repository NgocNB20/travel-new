        ...
        <div className="blog-one__single ">
            ...
            <div className="blog-one__content">
                ...
                <h3>
                 ...
                 {url==='vi'?'<p className="multi-line-truncate">Phong trào "người Việt Nam đi du lịch Việt Nam" đang được hội đam mê xê dịch hưởng ứng nhiệt tình. Bằng chứng là cứ đến cuối tuần hay dịp nghỉ lễ, các khu nghỉ dưỡng ven đô luôn trong tình trạng "cháy phòng".</p>':''}
            </div>
        </div>
    )
}
