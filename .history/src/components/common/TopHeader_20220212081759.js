  ...
  return (
    <div className="topbar-one">
      <div className="container-fluid">
        ...
        {/* Modal */}
        {isLogin?(<div className="modal fade" id="exampleModal" tabIndex={-1} role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div className="form-outline mb-4">
          <input type="email" name="email" id="form2Example1" className="form-control" onChange={setParams} />
          <label className="form-label" htmlFor="form2Example1">Email address</label>
        </div>
        {/* Password input */}
        <div className="form-outline mb-4">
          <input type="email" name="password" id="form2Example2" className="form-control" onChange={setParams} />
