    ...
    <div className="tour-sidebar">
        <div className="tour-sidebar__search tour-sidebar__single"id="book-tour-form">
            ...
            <form className="tour-sidebar__search-form">
                ...
                <div className="input-group"><small for="book-time">Giờ</small>
                    <input type="time" id="book-time" placeholder="Giờ"/>
                </div>
                <div className="input-group">
                    <small htmlFor="book-day">Ngày khởi hành</small>
                ...
                <div className="input-group">
                    <button type="button" className="thm-btn">Đặt tour</button>
                </div>
            </form>
        </div>
    </div>
