...
function RestaurantDetail() {
    return (
        <div className="tour-details__content">
            ...
            <ul className="tour-details__list list-unstyled"><li><i class="fa fa-check"></i> Wifi miễn phí</li><li><i class="fa fa-check"></i> Hoá đơn đỏ</li><li><i class="fa fa-check"></i> Phục vụ tại bàn</li><li><i class="fa fa-check"></i> Phòng riêng</li><li><i class="fa fa-check"></i> Máy lạnh</li><li><i class="fa fa-check"></i> điều hòa</li></ul>
