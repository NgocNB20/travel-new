...
import URL_IMAGE_RESTAURANT from "../../constants/constant.js";
    ...
    return (
        ...
        <div className="box_grid">  
            <figure>
                ...
                <Link to="#">
                    <div className="img-bg bg-img" style={{height: '210px', width: '100%', backgroundImage: `url(${URL_IMAGE_RESTAURANT+imageRestaurants[0].url})`}} />                    
                </Link>
