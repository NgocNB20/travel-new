    ...
    return (
        <div className="tour-details__content">
            ...
            <ul class="tour-details__list list-unstyled">
                <li><i class="fa fa-check"></i> Công việc</li>
                <li><i class="fa fa-check"></i> làm ăn</li>
                <li><i class="fa fa-check"></i> tiếp khách</li>
                <li><i class="fa fa-check"></i> Gia đình</li>
                <li><i class="fa fa-check"></i> Hội họp</li>
                <li><i class="fa fa-check"></i> Lãng mạn</li>
                <li><i class="fa fa-check"></i> hẹn hò</li>
                <li><i class="fa fa-check"></i> Uống bia</li>
                <li><i class="fa fa-check"></i> nhậu</li>
            </ul>
