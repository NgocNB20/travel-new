    ...
    return (
        <div className="tour-details__content">
            ...
            <ul className="tour-one__meta list-unstyled">
                <li><a><i className="fas fa-home"></i> Tầng 2, Số 2211 đường Hùng Vương, phường Nông Trang, thành Phố Việt Trì, tỉnh Phú Thọ</a></li>
                <li><a><i className="fas fa-phone-alt"></i> 0210 3883 678</a></li>
            </ul>
