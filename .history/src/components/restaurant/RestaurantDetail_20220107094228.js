...
function RestaurantDetail() {
    return (
        <div className="tour-details__content">
            ...
            <div className="blog-details__details"><p>- Chả các lăng</p><p>- Cá lăng xào cần tỏi</p><p>- Cá lăng nướng</p><p>- Cá lăng om chuối đậu</p><p>- Cá lăng nấu canh chua</p><p>- Các món ăn khác&nbsp;</p></div>
