...
function RestaurantDetail({restaurant}) {
    ...
    return (
        <div className="tour-details__content">
            ...
            <div className="blog-details__image"><img src={constant.URL_IMAGE_RESTAURANT+imageRestaurants[1].url} alt="Khu sinh Thái Đền Hùng – Budapest" className="img-fluid"/></div> 
