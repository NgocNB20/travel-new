...
function RestaurantDetail() {
    return (
        <div className="tour-details__content">
            ...
            <div className="blog-details__image"><img src="/DataFiles/2021/06/Files/20210606-200739-cTcbY6FO.jpg" alt="Khu sinh Thái Đền Hùng – Budapest" className="img-fluid"/></div> 
