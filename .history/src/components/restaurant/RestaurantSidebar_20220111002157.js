...
function RestaurantSidebar() {
    return (
        ...
        <div className="tour-sidebar">
            ...
            <img src={anh2} alt="" /><span>Phường Nông Trang</span><h3>
            <a href="/vi/restaurant/details/nha-hang-vy-anh-6">Nhà hàng Vy Anh</a></h3>
            </div><div className="tour-sidebar__featured-single">
            <img src={anh2} alt="" /><span>Phường Nông Trang</span><h3><a href="/vi/restaurant/details/kichi-kichi-lau-bang-chuyen-viet-tri-12">Kichi Kichi - lẩu băng chuyền Việt Trì</a></h3></div></div></div>
    </div>
