        ...
        <div className="blog-one__single ">
            ...
            <div className="blog-one__content">
                <ul className="list-unstyled blog-one__meta">
                    ...
                    <li> <Link to="#" title="Lượt xem"><i className="far fa-eye" />{blog.number_view}</Link> </li>
                    <li> <Link to="#" title="Lượt thích"><i className="far fa-heart" />{blog.number_like}</Link> </li>
                </ul>
                <h3>
